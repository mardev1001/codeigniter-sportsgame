            ...
            <div class="sidebar-content">
                ...
                <ul class="chat-users clearfix">
                    <li>
                        <a href="javascript:void(0)" class="chat-user-online">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar12.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="chat-user-online">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar15.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="chat-user-online">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar10.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="chat-user-online">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar4.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="chat-user-away">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar7.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="chat-user-away">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar9.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="chat-user-busy">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar16.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar1.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)">
                    ...
                    <li>
                        <a href="javascript:void(0)">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar3.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar13.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)">
                            <span></span>
                            <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle">
                        </a>
                    </li>
                </ul>
                <!-- END Chat Users -->
                ...
                <div class="chat-talk display-none">
                    ...
                    <div class="chat-talk-info sidebar-section">
                        <img src="<?php echo base_url('adminassets') ?>/img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle pull-left">
        ...
        <div class="sidebar-scroll">
            ...
            <div class="sidebar-content">
                ...
                <a href="index.php" class="sidebar-brand">
                    <i class="gi gi-flash"></i><strong>Sports</strong>Admin
                </a>
                <!-- END Brand -->
               ...
               <div class="sidebar-section sidebar-user clearfix">
                    <!--div class="sidebar-user-avatar">
                        <a href="page_ready_user_profile.php">
                            <img src="<?php //echo base_url('adminassets') ?>/img/placeholders/avatars/avatar2.jpg" alt="avatar">
                        </a>
                    </div>-->
					
                 <div class="sidebar-user-name"><?php echo ucfirst($sess_data['fname']).' '.ucfirst($sess_data['lname']); ?></div>
                    <!--<div class="sidebar-user-links">
                        ...
                        <a href="<?php //echo base_url('dashboard/logout'); ?>" data-toggle="tooltip" data-placement="bottom" title="Logout"><i class="gi gi-exit"></i></a>
                    </div>-->
                </div>
                <!-- END User Info -->
                ...
                <ul class="sidebar-section sidebar-themes clearfix">
                    ...
                    <li>
                        <a href="javascript:void(0)" class="themed-background-dark-night themed-border-night" data-theme="<?php echo base_url('adminassets')?>/css/themes/night.css" data-toggle="tooltip" title="Night"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-dark-amethyst themed-border-amethyst" data-theme="<?php echo base_url('adminassets')?>/css/themes/amethyst.css" data-toggle="tooltip" title="Amethyst"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-dark-modern themed-border-modern" data-theme="<?php echo base_url('adminassets')?>/css/themes/modern.css" data-toggle="tooltip" title="Modern"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-dark-autumn themed-border-autumn" data-theme="<?php echo base_url('adminassets')?>/css/themes/autumn.css" data-toggle="tooltip" title="Autumn"></a>
                    </li>
                    <li class="active">
                        <a href="javascript:void(0)" class="themed-background-dark-flatie themed-border-flatie" data-theme="<?php echo base_url('adminassets')?>/css/themes/flatie.css" data-toggle="tooltip" title="Flatie"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-dark-spring themed-border-spring" data-theme="<?php echo base_url('adminassets')?>/css/themes/spring.css" data-toggle="tooltip" title="Spring"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-dark-fancy themed-border-fancy" data-theme="<?php echo base_url('adminassets')?>/css/themes/fancy.css" data-toggle="tooltip" title="Fancy"></a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="themed-background-dark-fire themed-border-fire" data-theme="<?php echo base_url('adminassets')?>/css/themes/fire.css" data-toggle="tooltip" title="Fire"></a>
                    </li>-->
                </ul>
                <!-- END Theme Colors -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url('dashboard/logout'); ?>"><i class="fa fa-ban fa-fw pull-right"></i> Logouts</a>
                        </li>
