...
<div id="login-background">
    ...
    <!--<img src="<?php echo base_url('adminassets') ?>/img/placeholders/headers/vegas_login.jpg" alt="Login Background" >-->
...
<div id="login-container" class="animation-fadeIn">
    ...
    <div class="block remove-margin">
        ...
        <!--<form action="index.php" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">-->
			...
			<?php echo form_open(base_url('verifylogin'),array('id'=>'form-login','class'=>'form-horizontal form-bordered form-control-borderless')) ?>
...
<script src="<?php echo base_url('adminassets'); ?>/js/pages/login.js"></script>
