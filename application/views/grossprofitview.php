			...
			<div id="content">
				...
				<div class="table-data">
						  ...
						  <?php 
							if(isset($result) && count($result)>0)
							{
							  ...
							  <tr>
								...
								<td><?php echo $row['gp_profit_bet']>0?'+'.$row['gp_profit_bet'].'%':$row['gp_profit_bet'].'%'; ?></td>
				 ...
				 <div class="summary">
					 ...
					 <h3 style="text-align:center;">Gross Profit (as % Bankroll)</h3>
				 </div>
				 <div class="offer">					
					<div class="left">
					   <div class="profit">
							<p>Gross Profit (as % of Bankroll)</p>
							<p>Bet Day <?php if(isset($singleresult)) { echo $singleresult['fbet_day']; } ?></p>
							<p>Blue/Green Strategy</p>
							<?php
							$print = '';
							if(isset($singleresult)) {
								if ($singleresult['gp_profit_bet']>=0)
									$print = '+'.$singleresult['gp_profit_bet'].'%';
								else
									$print = $singleresult['gp_profit_bet'].'%';
							}
							?>
					...
					<div class="right">
						<div class="profit">
							<p>Compounded<br>(From<br/><?php echo date('m/d/Y',strtotime($row['fbet_date'])); ?> To<br/>Date)</p>
							<p>Blue/Green Strategy</p>
							<?php
							$print = '';
							if(isset($singleresult)) {
		...
		<div id="footer">
            ...
            <div id="footer-bottom">
				<ul>
					...
					<li class="active"><a href="<?php echo base_url('grossprofit'); ?>"><img src="<?php echo base_url('adminassets') ?>/img/DoubleDollars.png" alt="#"/><span>Gross Profit</span></a></li>
